...
ブラウザで [http://localhost:8000](http://localhost:8000) を開き、「タップしてスタート」を押すとカメラが起動します。
...
- 「タップしてスタート」を押し、カメラ利用を許可するとマーカー検出が始まります。
